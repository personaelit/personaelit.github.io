...
import { applyStyle as lavaApplyStyle } from './effects/lavalamp.js';
...
const INTERACTIVE_SEL = 'button, a, input, textarea, .quick-link, .block, .modal-content, #effectsPanel, #controls, .search-box, .theme-toggle, #breathingGuide, #breathDim';
...
window.addEventListener('load', () => {
  ...
  setThemeChangeCallback(() => { if (effects.lavalamp) lavaApplyStyle(); });
